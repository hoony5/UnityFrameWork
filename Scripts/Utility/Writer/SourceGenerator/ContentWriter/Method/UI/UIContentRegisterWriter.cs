...
{
    public class UIContentRegisterWriter : UIContentWriterBase
    {
        public string modelName;
        private RegisterType @operator;
        
        public UIContentRegisterWriter(IList<(string type, string name)> elementInfos, RegisterType @operator)
        {
